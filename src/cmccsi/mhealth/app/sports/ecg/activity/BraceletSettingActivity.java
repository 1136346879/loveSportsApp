...
public class BraceletSettingActivity extends BaseActivity implements
	...
	private void initViews() {
		...
		tpSport = (TimePicker) findViewById(R.id.tp_sport);
		tpSleep = (TimePicker) findViewById(R.id.tp_sleep);
		llSleep = (LinearLayout) findViewById(R.id.ll_sleep);
		tbSport = (ToggleButton) findViewById(R.id.tb_sport);
		tbSleep = (ToggleButton) findViewById(R.id.tb_sleep);
